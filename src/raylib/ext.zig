...
pub const MaterialMap = c.MaterialMap;
pub const Material = c.Material;
pub const Transform = c.Transform;
pub const BoneInfo = c.BoneInfo;
pub const Model = c.Model;
pub const ModelAnimation = c.ModelAnimation;
pub const Ray = c.Ray;
pub const RayCollision = c.RayCollision;
pub const BoundingBox = c.BoundingBox;
pub const Wave = c.Wave;
pub const AudioStream = c.AudioStream;
pub const Sound = c.Sound;
pub const Music = c.Music;
pub const VrDeviceInfo = c.VrDeviceInfo;
pub const VrStereoConfig = c.VrStereoConfig;
pub const FilePathList = c.FilePathList;
pub const AutomationEvent = c.AutomationEvent;
pub const AutomationEventList = c.AutomationEventList;
...
pub extern fn UpdateModelAnimationBoneMatrices(model: Model, anim: ModelAnimation, frame: c_int) void;
